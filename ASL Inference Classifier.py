...
def sign_lang_recognition_asl():
    ...
    model_dict1 = pickle.load(open('D:\Documents\GEC Online Classes\ML-model\Sign-Suno\model1_updated.p', 'rb'))
    model_dict2 = pickle.load(open('D:\Documents\GEC Online Classes\ML-model\Sign-Suno\model2_updated.p', 'rb'))
    model1 = model_dict1['model1']
    model2 = model_dict2['model2']


    cap = cv2.VideoCapture(r"D:\Documents\GEC Online Classes\backend_py_3_10\sign_suno\videos\recorded-video.webm")
    ...
    labels_dict1 = {0:'1', 1:'3', 2:'4', 3:'5', 4:'7', 5:'8', 6:'9', 7:'A',8:'B',9:'C',10:'D',11:'E',12:'F',
                    13:'G',14:'H',15:'I',16:'J',17:'K',18:'L',19:'M',20:'N',21:'O_OR_0',22:'P',23:'Q',24:'R',
                    25:'S',26:'T',27:'U',28:'V_OR_2',29:'W_OR_6',30:'X',31:'Y',32:'Z',33:'Dont_like',34:'Hello',
                    35:'Like',36:'Love',37:'My',38:'No',39:'Space',40:'What',41:'Yes',42:'Your'}
